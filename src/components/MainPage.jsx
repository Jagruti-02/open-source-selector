...
function MainPage() {
  ...
  const [search, setSearch] = useState({
    ...
    async function fetchData() {
      try {
        let searchedPosts=[];
           const res  = await fetch(`${import.meta.env.VITE_BASE_URL}/similar_repos`,{
            method: 'POST',
            headers: {
          ...
          const res2  = await fetch(`${import.meta.env.VITE_BASE_URL}/similar_repos`,{
            method: 'POST',
            headers: {
              'Content-Type': 'application/json'
            }, 
          ...
          <div className="flex space-y-10 flex-col">
            <div className="flex items-center m-15">
              <div className="flex rounded w-full">
                <input
                  type="text"
                  className="block w-full px-16 py-3 text-blue-700 bg-white border rounded-md focus:border-blue-400 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 mt-10"
            ...
            <div className="flex rounded w-full">
                <input
                  type="text"
                  className="block w-full px-16 py-3 text-blue-700 bg-white border rounded-md focus:border-blue-400 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 mb-10"
